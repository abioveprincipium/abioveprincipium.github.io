document.addEventListener("DOMContentLoaded", () => {
  ...
  function activateSlide(index) {
    ...
    stackElem.innerHTML = `<span class="first-word">${words[0]} </span> ${words.slice(1).join(" ")}`;
